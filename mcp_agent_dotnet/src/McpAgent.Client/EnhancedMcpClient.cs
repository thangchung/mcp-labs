...
//    {
//        // Use the same HTTP client approach as the basic client, but with enhanced features
...
//        // Create direct HTTP client (same as basic, but we'll add enhanced features)
//        var directClient = new DirectHttpMcpClient(httpClient, _serverUrl, _loggerFactory);

//        // Initialize connection
//        await directClient.InitializeAsync();
...
//                await ResumeWithEnhancedSupport(directClient, existingSession);
//            }
//            else
//            {
//                await StartEnhancedInteractiveSession(directClient);
//            }
//        }
//        finally
//        {
...
//    private async Task ResumeWithEnhancedSupport(DirectHttpMcpClient client, SessionInfo sessionInfo)
//    {
...
//            if (result.GetProperty("content").EnumerateArray().FirstOrDefault().TryGetProperty("text", out var textResult))
//            {
//                var resultText = textResult.GetString() ?? "";
...
//    private async Task StartEnhancedInteractiveSession(DirectHttpMcpClient client)
//    {
//        // Display server capabilities (enhanced version)
